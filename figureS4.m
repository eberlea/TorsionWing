...
max = 6e-5*10; 
axis([0 100 min max])
plot(f,100*(2*abs(Y_flap(1:NFFT/2+1))),'k')
axis([0 100 min max])
h=text(-14.24,8e-5*10,'(di)');
set(h,'FontName','Times')
xlabel('f (Hz)','FontName','Times')
set(gca,'XTick',[22 28 47 53 72 78])
h = line([22 22],[min max]);
...
max = 6e-5*10; 
axis([0 100 min max])
plot(f,100*(2*abs(Y_flaprot(1:NFFT/2+1))),'k')
axis([0 100 min max])
h=text(-14.24,8e-5*10,'(ei)');
set(h,'FontName','Times')
xlabel('f (Hz)','FontName','Times')
set(gca,'XTick',[22 28 47 53 72 78])
h = line([22 22],[min max]);
...
axis([0 100 min max])
xlabel('f (Hz)','FontName','Times')
ylabel('|F[\Delta\epsilon_y_y_,_F]| (%)','FontName','Times')
set(gca,'XTick',[22 28 47 53 72 78])
h = line([22 22],[min max]);
set(h,'LineStyle','--')
set(h,'Color','r')
...
axis([0 100 min max])
xlabel('f (Hz)','FontName','Times')
ylabel('|F[\Delta\epsilon_y_y_,_F_&_R]| (%)','FontName','Times')
set(gca,'XTick',[22 28 47 53 72 78])
h = line([22 22],[min max]);
set(h,'LineStyle','--')
set(h,'Color','r')
